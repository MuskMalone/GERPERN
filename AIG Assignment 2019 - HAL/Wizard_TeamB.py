...
class Wizard_TeamB(Character):
    ...
    def __init__(self, world, image, projectile_image, base, position, explosion_image = None):
        ...
        seeking_state = WizardStateSeeking_TeamB(self)
        attacking_state = WizardStateAttacking_TeamB(self)
        ko_state = WizardStateKO_TeamB(self)
...
class WizardStateSeeking_TeamB(State):
...
class WizardStateAttacking_TeamB(State):
...
class WizardStateKO_TeamB(State):
